...
namespace Api.Controllers
{
    public class TurnoController : BaseController
    {
        ...
        {
            var entity = await _unitOfWork.Turnos.GetAllAsync();
            return _mapper.Map<List<TurnoDto>>(entity);
        }
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<Turno>> Post(TurnoDto entityDto)
        {
            var entity = _mapper.Map<Turno>(entityDto);
        /*
        ...
        */
        ...
        {
            var entity = await _unitOfWork.Turnos.GetByIdAsync(id);
            if (entity == null)
            {
                return NotFound();
            }
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<TurnoDto>> Put(int id, [FromBody] TurnoDto entityDto)
        {
            var entity = _mapper.Map<Turno>(entityDto);
            if (entity.Id == 0)
            {
        ...
        */
            entityDto.Id = entity.Id;
            _unitOfWork.Turnos.Update(entity);
            await _unitOfWork.SaveAsync();
            return entityDto;
        }
        [HttpDelete("{id}")]
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            _unitOfWork.Turnos.Remove(entity);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
